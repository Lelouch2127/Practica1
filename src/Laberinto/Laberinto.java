...
public class Laberinto {
	...
	public static void main(String[] args) {
		...
		Escenarios esce = new Escenarios();			//LLAMA A LA CLASE ESCENARIOS Y CREA UNA VARIABLE DE TIPO ESCENARIOS
		Metodo metodo = new Metodo();				//LLAMA A LA CLASE METODO Y CREA UNA VARIABLE DE ESTE TIPO PARA PODER UTILIZAR SUS FUNCIONES
